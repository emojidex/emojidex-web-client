describe 'EmojidexEmoji', ->
  ...
  describe 'check update', ->
    it 'need update', (done) ->
      console.log 'EmojidexEmoji:seedUpdated', EC_spec.Data.storage.hub_cache.emojidex.seedUpdated
      EC_spec.Data.storage.update('emojidex.seedUpdated', new Date('1/1/2016').toString()).then =>
        console.log 'need update:emojidex.seedUpdated', EC_spec.Data.storage.hub_cache.emojidex.seedUpdated
        expect(EC_spec.Emoji.checkUpdate()).toBe(true)
        done()

    it 'unnecessary update', (done) ->
      console.log 'unnecessary update:start ---'
      EC_spec.Data.storage.update('emojidex.seedUpdated', new Date().toString()).then =>
        console.log 'unnecessary update:emojidex.seedUpdated', EC_spec.Data.storage.hub_cache.emojidex.seedUpdated
