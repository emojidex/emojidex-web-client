...
return null!=a.link&&""!=a.link?"<a href='"+a.link+"' emoji-code='"+self.escapeTerm(a.code)+"'>"+c+"</a>":c}},{key:"emojiToMD",value:function(a){var b=arguments.length>1&&void 0!==arguments[1]?arguments[1]:self.EC.defaults.size_code,c="!["+(null==a.moji||""==a.moji?a.code:a.moji)+"](http://"+self.EC.env.cdn_addr+"/emoji/"+b+"/"+self.escapeTerm(a.code)+'.png "'+self.deEscapeTerm(a.code)+'")';return null!=a.link&&""!=a.link?"["+c+" ]("+a.link+")":c}},{key:"deEmojifyHTML",value:function(a){var b=!(arguments.length>1&&void 0!==arguments[1])||arguments[1];a=self.deLinkHTML(a);var c=a.match(self.img_pattern),d=!0,e=!1,f=void 0;try{for(var g,h=c[Symbol.iterator]();!(d=(g=h.next()).done);d=!0){if(target=g.value,b){var i=target.match(self.emoji_moji_tag_attr_pattern);if(null!=i&&1!=i.length){a=a.replace(target,i[1]);continue}}var j=target.match(self.emoji_code_tag_attr_pattern);a=a.replace(target,self.encapsulateCode(j[1]))}}catch(k){e=!0,f=k}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return a}},{key:"deLinkHTML",value:function(a){var b=a.match(self.a_pattern),c=!0,d=!1,e=void 0;try{for(var f,g=b[Symbol.iterator]();!(c=(f=g.next()).done);c=!0)target=f.value,a=a.replace(target,target.match(self.img_pattern)[0])}catch(h){d=!0,e=h}finally{try{!c&&g["return"]&&g["return"]()}finally{if(d)throw e}}return a}}]),a}();