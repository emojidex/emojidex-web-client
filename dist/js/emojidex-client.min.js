...
if("throw"===d.type){var e=d.arg;l(c)}return e}}throw new Error("illegal catch attempt")},delegateYield:function(a,b,c){return this.delegate={iterator:n(a),resultName:b,nextLoc:c},B}}}("object"==typeof a?a:"object"==typeof window?window:"object"==typeof self?self:this)}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}]},{},[1]),!function(a){function b(a,c){c=c||{},this._id=b._generateUUID(),this._promise=c.promise||Promise,this._frameId=c.frameId||"CrossStorageClient-"+this._id,this._origin=b._getOrigin(a),this._requests={},this._connected=!1,this._closed=!1,this._count=0,this._timeout=c.timeout||5e3,this._listener=null,this._installListener();var d;c.frameId&&(d=document.getElementById(c.frameId)),d&&this._poll(),d?this._hub=d.contentWindow:this._createFrame(a)}b.frameStyle={display:"none",position:"absolute",top:"-999px",left:"-999px"},b._getOrigin=function(a){var b,c,d;return b=document.createElement("a"),b.href=a,b.host||(b=window.location),c=b.protocol&&":"!==b.protocol?b.protocol:window.location.protocol,d=c+"//"+b.host,d=d.replace(/:80$|:443$/,"")},b._generateUUID=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0,c="x"==a?b:3&b|8;return c.toString(16)})},b.prototype.onReadyFrame=function(){var a=this;return this._hub?this._promise.resolve():this._closed?this._promise.reject(new Error("CrossStorageClient has closed")):new this._promise(function(b,c){var d=setTimeout(function(){c(new Error("CrossStorageClient could not ready frame"))},a._timeout),e=setInterval(function(){a._hub&&(clearTimeout(d),clearInterval(e),b())},100)})},b.prototype.onConnect=function(){var a=this;return this._connected?this._promise.resolve():this._closed?this._promise.reject(new Error("CrossStorageClient has closed")):(this._requests.connect||(this._requests.connect=[]),new this._promise(function(b,c){var d=setTimeout(function(){c(new Error("CrossStorageClient could not connect"))},a._timeout);a._requests.connect.push(function(a){return clearTimeout(d),a?c(a):void b()})}))},b.prototype.set=function(a,b,c){return this._request("set",{key:a,value:b,ttl:c})},b.prototype.get=function(){var a=Array.prototype.slice.call(arguments);return this._request("get",{keys:a})},b.prototype.del=function(){var a=Array.prototype.slice.call(arguments);return this._request("del",{keys:a})},b.prototype.clear=function(){return this._request("clear")},b.prototype.getKeys=function(){return this._request("getKeys")},b.prototype.close=function(){var a=document.getElementById(this._frameId);a&&a.parentNode.removeChild(a),window.removeEventListener?window.removeEventListener("message",this._listener,!1):window.detachEvent("onmessage",this._listener),this._connected=!1,this._closed=!0},b.prototype._installListener=function(){var a=this;this._listener=function(b){var c,d,e,f;if(!a._closed&&b.data&&"string"==typeof b.data&&(d="null"===b.origin?"file://":b.origin,d===a._origin))if("cross-storage:unavailable"!==b.data){if(-1!==b.data.indexOf("cross-storage:")&&!a._connected){if(a._connected=!0,!a._requests.connect)return;for(c=0;c<a._requests.connect.length;c++)a._requests.connect[c](e);delete a._requests.connect}if("cross-storage:ready"!==b.data){try{f=JSON.parse(b.data)}catch(g){return}f.id&&a._requests[f.id]&&a._requests[f.id](f.error,f.result)}}else{if(a._closed||a.close(),!a._requests.connect)return;for(e=new Error("Closing client. Could not access localStorage in hub."),c=0;c<a._requests.connect.length;c++)a._requests.connect[c](e)}},window.addEventListener?window.addEventListener("message",this._listener,!1):window.attachEvent("onmessage",this._listener)},b.prototype._poll=function(){var a,b,c;a=this,c="file://"===a._origin?"*":a._origin,b=setInterval(function(){return a._connected?clearInterval(b):void(a._hub&&a._hub.postMessage("cross-storage:poll",c))},1e3)},b.prototype._createFrame=function(a){var c,d,e=this;c=window.document.createElement("iframe"),c.id=this._frameId;for(d in b.frameStyle)b.frameStyle.hasOwnProperty(d)&&(c.style[d]=b.frameStyle[d]);window.document.body.appendChild(c),c.onload=function(){e._hub=c.contentWindow},c.src=a},b.prototype._request=function(a,b){var c,d;return this._closed?this._promise.reject(new Error("CrossStorageClient has closed")):(d=this,d._count++,c={id:this._id+":"+d._count,method:"cross-storage:"+a,params:b},new this._promise(function(a,b){var e,f,g;e=setTimeout(function(){d._requests[c.id]&&(delete d._requests[c.id],b(new Error("Timeout: could not perform "+c.method)))},d._timeout),d._requests[c.id]=function(f,g){return clearTimeout(e),delete d._requests[c.id],f?b(new Error(f)):void a(g)},Array.prototype.toJSON&&(f=Array.prototype.toJSON,Array.prototype.toJSON=null),g="file://"===d._origin?"*":d._origin,d._hub.postMessage(JSON.stringify(c),g),f&&(Array.prototype.toJSON=f)}))},"undefined"!=typeof module&&module.exports?module.exports=b:"undefined"!=typeof exports?exports.CrossStorageClient=b:"function"==typeof define&&define.amd?define([],function(){return b}):a.CrossStorageClient=b}(this);var EmojidexClient=function b(a){var c=this;_classCallCheck(this,b),this.env={api_ver:1,cdn_addr:"cdn.emojidex.com",s_cdn_addr:"cdn.emojidex.com",asset_addr:"assets.emojidex.com",s_asset_addr:""},this.defaults={locale:"en",api_url:"https://www.emojidex.com/api/v1/",cdn_url:"https://cdn.emojidex.com/emoji/",closed_net:!1,min_query_len:4,size_code:"xhdpi",detailed:!1,limit:32,onReady:function(a){return{}}},this.options=$.extend({},this.defaults,a),this.closed_net=this.options.closed_net,this.api_url=this.options.api_url,this.cdn_url=this.options.cdn_url,this.size_code=this.options.size_code,this.detailed=this.options.detailed,this.limit=this.options.limit,this.locale=this.options.locale,this.Data=new EmojidexData(this,this.options).then(function(a){c.Util=new EmojidexUtil(c),c.User=new EmojidexUser(c),c.Indexes=new EmojidexIndexes(c),c.Search=new EmojidexSearch(c),c.Emoji=new EmojidexEmoji(c),c.Categories=new EmojidexCategories(c)}).then(function(){c.options.onReady(c)})},_createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),EmojidexCategories=function(){function a(b){var c=this;return _classCallCheck(this,a),this.EC=b,this._categories=this.EC.Data.categories(),this.sync().then(function(){return c.EC.Categories=c})}return _createClass(a,[{key:"_categoriesAPI",value:function(a,b,c,d){var e=this,f={page:1,limit:this.EC.limit,detailed:this.EC.detailed};return null!==this.EC.User.auth_info.token&&$.extend(f,{auth_token:this.EC.User.auth_info.token}),$.extend(f,c),this.called_func=d,this.called_data={category_name:a,callback:b,param:f},$.ajax({url:this.EC.api_url+"emoji",dataType:"json",data:f,success:function(c){return e.meta=c.meta,e.results=c.emoji,e.cur_page=c.meta.page,e.count=c.meta.count,e.EC.Emoji.combine(c.emoji).then(function(){return __guardFunc__(b,function(d){return d(c.emoji,{category_name:a,callback:b,param:f})})})}})}},{key:"getEmoji",value:function(a,b,c){var d={category:a};return $.extend(d,c),this._categoriesAPI(a,b,d,this.getEmoji)}},{key:"next",value:function(){return this.count===this.called_data.param.limit&&this.called_data.param.page++,this.called_func(this.called_data.category_name,this.called_data.callback,this.called_data.param,{ajax:this.called_func})}},{key:"prev",value:function(){return this.called_data.param.page>1&&this.called_data.param.page--,this.called_func(this.called_data.category_name,this.called_data.callback,this.called_data.param,{ajax:this.called_func})}},{key:"sync",value:function(a,b){var c=this;return null!=__guard__(this._categories,function(a){return a.length})?new Promise(function(b,d){return __guardFunc__(a,function(a){return a(c._categories)}),b()}):("undefined"!=typeof b&&null!==b||(b=this.EC.locale),$.ajax({url:this.EC.api_url+"categories",dataType:"json",data:{locale:b}}).then(function(b){return c._categories=b.categories,c.EC.Data.categories(b.categories).then(function(){return __guardFunc__(a,function(a){return a(c._categories)})})}))}},{key:"all",value:function(a){var b=this;return null!=this._categories?__guardFunc__(a,function(a){return a(b._categories)}):setTimeout(function(){return b.all(a)},500)}}]),a}(),_createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),EmojidexData=function(){function a(b,c){var d=this;return _classCallCheck(this,a),this.EC=b,this.options=c,this._def_auth_info={status:"none",user:"",token:null,r18:!1,premium:!1,premium_exp:null,pro:!1,pro_exp:null},null!=this.options.storageHubPath?this.storage=new EmojidexDataStorage(this.options.storageHubPath):this.storage=new EmojidexDataStorage,this.storage.hub.onReadyFrame().then(function(){return d.storage.hub.onConnect()}).then(function(){return d.storage.hub.getKeys()}).then(function(a){return a.indexOf("emojidex")!==-1?d.storage.update_cache("emojidex"):d.storage.update("emojidex",{moji_codes:{moji_string:"",moji_array:[],moji_index:{}},emoji:d.EC.options.emoji||[],history:d.EC.options.history||[],favorites:d.EC.options.favorites||[],categories:d.EC.options.categories||[],auth_info:d.EC.options.auth_info||d._def_auth_info})}).then(function(a){return d._needUpdate()?d._init_moji_codes():d.storage.get("emojidex")}).then(function(a){return d.moji_codes=d.storage.get("emojidex.moji_codes"),d.EC.Data=d})}return _createClass(a,[{key:"_init_moji_codes",value:function(){var a=this;arguments.length>0&&void 0!==arguments[0]&&arguments[0];return this.storage.update("emojidex.moji_codes_updated",(new Date).toString()).then(function(){return $.ajax({url:a.EC.api_url+"moji_codes",dataType:"json"})}).then(function(b){return a.storage.update("emojidex.moji_codes",b)})}},{key:"_needUpdate",value:function(){return!this.storage.isSet("emojidex.utfInfoUpdated")||(current=new Date,updated=new Date(this.storage.get("emojidex.utfInfoUpdated")),current-updated>=12096e5)}},{key:"emoji",value:function b(a){if(null!=a){if(this.storage.hub_cache.emojidex.emoji.length>0){for(var c=this.storage.hub_cache.emojidex.emoji,d=0;d<a.length;d++)for(var e=a[d],f=0;f<c.length;f++){var b=c[f];if(e.code===b.code){c.splice(c.indexOf(b),1,e);break}b===c[c.length-1]&&c.push(e)}return this.storage.update("emojidex",{emoji:c})}return this.storage.update("emojidex",{emoji:a})}return null!=this.storage.hub_cache.emojidex.emoji?this.storage.hub_cache.emojidex.emoji:void 0}},{key:"favorites",value:function(a){return null!=a?this.storage.update("emojidex",{favorites:a}):this.storage.hub_cache.favorites}},{key:"history",value:function(a){return null!=a?this.storage.update("emojidex",{history:a}):this.storage.hub_cache.history}},{key:"categories",value:function(a){return null!=a?this.storage.update("emojidex",{categories:a}):this.storage.hub_cache.categories}},{key:"auth_info",value:function(a){return null!=a?(this.EC.User.auth_info=a,this.storage.update("emojidex",{auth_info:a})):this.storage.hub_cache.auth_info}}]),a}(),_createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),EmojidexDataStorage=function(){function a(){var b=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"https://www.emojidex.com/hub/0.8.2";_classCallCheck(this,a),this.hub=new CrossStorageClient(b,{frameId:"emojidex-client-storage-hub"}),this.hub_cache={}}return _createClass(a,[{key:"_get_chained_data",value:function(a,b){var c=!(arguments.length>2&&void 0!==arguments[2])||arguments[2];a=this._get_parsed_query(a);var d=function f(c,d){return 0===a.array.length?c[d]=b:(c[d]={},f(c[d],a.array.shift())),c},e=d({},a.array.shift());return c?e:e[a.first]}},{key:"_get_hub_data",value:function(a){var b=this;return a=a.split("."),this.hub.onConnect().then(function(){return b.hub.get(a.shift())}).then(function(b){if(a.length)for(var c=0;c<a.length;c++){var d=a[c];b=b[d]}return b})}},{key:"_get_parsed_query",value:function(a){var b=a.split(".");return a={code:a,array:b,first:b[0]}}},{key:"get",value:function(a){a=a instanceof Array?a:a.split(".");var b=this.hub_cache;if(a.length)for(var c=0;c<a.length;c++){var d=a[c];b=b[d]}return b}},{key:"set",value:function(a,b,c){var d=this,e=a.split(".")[0];return this.hub.onConnect().then(function(){if(c){var f={};return f[e]=b,d.hub.set(e,f)}return d.hub.set(e,d._get_chained_data(a,b))}).then(function(){return d.update_cache(e)})}},{key:"update",value:function(a,b){var c=$.extend(!0,{},this.get(a.split(".")[0]),this._get_chained_data(a,b,!1));return this.set(a,c,!0)}},{key:"update_cache",value:function(a){var b=this;return this.hub.onConnect().then(function(){return a?a:b.hub.getKeys()}).then(function(a){return b.hub.get(a)}).then(function(c){return a?b.hub_cache[a]=c[a]:b.hub_cache=c})}},{key:"_remove",value:function(a){if(a=this._get_parsed_query(a),1===a.array.length)return this.hub.del(a.code);for(var b=void 0,c=b=this.get(a.array.shift()),d=0;d<a.array.length-1;)b=b[a.array[d]],d++;return delete b[a.array[d]],this.update(a.first,c)}},{key:"clear",value:function(){var a=this;return this.hub.onConnect().then(function(){return a.hub.clear()})}},{key:"keys",value:function b(a){var c=this;if(a){var b=[];for(var d in this.get(a))b.push(d);return b}return this.hub.onConnect().then(function(){return c.hub.getKeys()})}},{key:"isEmpty",value:function(a){return!this.get(a)}},{key:"isSet",value:function(a){return!!this.get(a)}}]),a}(),_createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),EmojidexEmoji=function(){function a(b){_classCallCheck(this,a),this.combine=this.combine.bind(this),this.EC=b,this._emoji_instance=[]}return _createClass(a,[{key:"_emoji",value:function(){return null!=this._emoji_instance?this._emoji_instance:this.checkUpdate()?(this.EC.Data.storage.update("emojidex.seedUpdated",(new Date).toString()),this.seed()):this._emoji_instance=this.EC.Data.storage.get("emojidex.emoji")}},{key:"checkUpdate",value:function(){if(this.EC.Data.storage.isSet("emojidex.seedUpdated")){var a=new Date,b=new Date(this.EC.Data.storage.get("emojidex.seedUpdated"));return a-b>=1728e5}return!0}},{key:"seed",value:function(a){return this.EC.Indexes["static"](["utf_emoji","extended_emoji"],null,a)}},{key:"all",value:function(){return this._emoji()}},{key:"search",value:function(a,b){var c=this._emoji().filter(function(b){return b.code.match(a)}).map(function(a){return a});return __guardFunc__(b,function(a){return a(c)}),c}},{key:"starting",value:function(a,b){var c=this._emoji().filter(function(b){return b.code.match("^"+a)}).map(function(a){return a});return __guardFunc__(b,function(a){return a(c)}),c}},{key:"ending",value:function(a,b){var c=this._emoji().filter(function(b){return b.code.match(a+"$")}).map(function(a){return a});return __guardFunc__(b,function(a){return a(c)}),c}},{key:"tags",value:function(a,b){a=this.EC.Util.breakout(a);for(var c=__guard__(b,function(a){return a.selection})||this._emoji(),d=[],e=function(b){var e=a[b];d=d.concat(c.filter(function(a){return $.inArray(e,a.tags)>=0}).map(function(a){return a}))},f=0;f<a.length;f++)e(f);return d}},{key:"categories",value:function(a,b){a=this.EC.Util.breakout(a);for(var c=__guard__(b,function(a){return a.selection})||this._emoji(),d=[],e=function(b){var e=a[b];d=d.concat(c.filter(function(a){return a.category===e}).map(function(a){return a}))},f=0;f<a.length;f++)e(f);return d}},{key:"advanced",value:function(a){return this.categories(a.categories,{selection:this.tags(a.tags,{selection:this.search(a.term)})})}},{key:"combine",value:function(a){var b=this;return this.EC.Data.emoji(a).then(function(a){return b._emoji_instance=a.emoji})}},{key:"flush",value:function(){return this._emoji_instance=[],this.EC.Data.storage._remove("emojidex.emoji")}}]),a}(),_createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),EmojidexIndexes=function(){function a(b){_classCallCheck(this,a),this.EC=b,this.results=[],this.cur_page=1,this.count=0}return _createClass(a,[{key:"_indexesAPI",value:function(a,b,c,d){var e=this,f={page:1,limit:this.EC.limit,detailed:this.EC.detailed};return null!==this.EC.User.auth_info.token&&$.extend(f,{auth_token:this.EC.User.auth_info.token}),$.extend(f,c),null!=d&&(this.indexed_func=d,this.indexed={query:a,callback:b,param:f}),$.ajax({url:this.EC.api_url+a,dataType:"json",data:f,success:function(a){return null!=a.status?(e.results=[],e.cur_page=0,e.count=0,__guardFunc__(b,function(a){return a([])})):(e.meta=a.meta,e.results=a.emoji,e.cur_page=a.meta.page,e.count=a.meta.count,e.EC.Emoji.combine(a.emoji).then(function(c){return __guardFunc__(b,function(b){return b(a.emoji)})}))},error:function(a){return e.results=[],e.cur_page=0,e.count=0,__guardFunc__(b,function(a){return a([])})}})}},{key:"index",value:function(a,b){return this._indexesAPI("emoji",a,b,this.index)}},{key:"newest",value:function(a,b){return this._indexesAPI("newest",a,b,this.newest)}},{key:"popular",value:function(a,b){return this._indexesAPI("popular",a,b,this.popular)}},{key:"user",value:function(a,b,c){return this._indexesAPI("users/"+a+"/emoji",b,c)}},{key:"static",value:function(a,b,c){var d=this,e=0,f=[],g=function(b){return $.ajax({url:b,dataType:"json",success:function(b){if(f=f.concat(b),++e===a.length)return d.EC.Emoji.combine(f).then(function(a){return __guardFunc__(c,function(b){return b(a)})})}})};return a.map(function(a){return g(b?d.EC.api_url+a+"?locale="+b:""+(d.EC.api_url+a))})}},{key:"select",value:function(a,b,c){return this.EC.Search.find(a,b,c)}},{key:"next",value:function(){return this.count===this.indexed.param.limit&&this.indexed.param.page++,this.indexed_func(this.indexed.callback,this.indexed.param,this.indexed_func)}},{key:"prev",value:function(){return this.indexed.param.page>1&&this.indexed.param.page--,this.indexed_func(this.indexed.callback,this.indexed.param,this.indexed_func)}}]),a}(),_createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),EmojidexSearch=function(){function a(b){_classCallCheck(this,a),this.EC=b,this.results=[],this.cur_page=1,this.count=0}return _createClass(a,[{key:"_searchAPI",value:function(a,b,c,d){var e=this,f={page:1,limit:this.EC.limit,detailed:this.EC.detailed};return null!==this.EC.User.auth_info.token&&$.extend(f,{auth_token:this.EC.User.auth_info.token}),$.extend(f,c),this.searched_func=d.ajax,this.searched={data:a,callback:b,param:f},$.ajax({url:this.EC.api_url+"search/emoji",dataType:"json",data:f,success:function(a){null!=a.status?(e.results=[],e.cur_page=0,e.count=0,"function"==typeof b&&b([])):(e.meta=a.meta,e.results=a.emoji,e.cur_page=a.meta.page,e.count=a.meta.count,e.EC.Emoji.combine(a.emoji),"function"==typeof b&&b(a.emoji))},error:function(a){e.results=[],e.cur_page=0,e.count=0,"function"==typeof b&&b([])}})}},{key:"search",value:function(a,b,c){return c=$.extend({code_cont:this.EC.Util.escapeTerm(a)},c),this._searchAPI(a,b,c,{ajax:this.search,storage:this.EC.Emoji.search})}},{key:"starting",value:function(a,b,c){return c=$.extend({code_sw:this.EC.Util.escapeTerm(a)},c),this._searchAPI(a,b,c,{ajax:this.starting,storage:this.EC.Emoji.starting})}},{key:"ending",value:function(a,b,c){return c=$.extend({code_ew:this.EC.Util.escapeTerm(a)},c),this._searchAPI(a,b,c,{ajax:this.ending,storage:this.EC.Emoji.ending})}},{key:"tags",value:function(a,b,c){return c=$.extend({"tags[]":this.EC.Util.breakout(a)},c),this._searchAPI(a,b,c,{ajax:this.tags,storage:this.EC.Emoji.tags})}},{key:"advanced",value:function(a,b,c){var d={code_cont:this.EC.Util.escapeTerm(a.term),"tags[]":this.EC.Util.breakout(a.tags),"categories[]":this.EC.Util.breakout(a.categories)};return $.extend(d,c),this._searchAPI(a,b,d,{ajax:this.advanced,storage:this.EC.Emoji.advanced})}},{key:"find",value:function(a){var b=this,c=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,d=arguments[2],e=this.EC.Data.emoji();a=this.EC.Util.deEscapeTerm(a);for(var f=0;f<e.length;f++){var g=e[f];if(g.code===a)return"function"==typeof c&&c(g),Promise.resolve(g)}var h={detailed:this.EC.detailed};return null!==this.EC.User.auth_info.token&&$.extend(h,{auth_token:this.EC.User.auth_info.token}),$.extend(h,d),$.ajax({url:this.EC.api_url+("emoji/"+this.EC.Util.makeURLSafe(a)),dataType:"json",data:h,success:function(a){return b.EC.Emoji.combine([a]),"function"==typeof c&&c(a),a},error:function(a){return"function"==typeof c&&c(a),a}})}},{key:"next",value:function(){return this.count===this.searched.param.limit&&this.searched.param.page++,this.searched_func(this.searched.data,this.searched.callback,this.searched.param,{ajax:this.searched_func})}},{key:"prev",value:function(){return this.searched.param.page>1&&this.searched.param.page--,this.searched_func(this.searched.data,this.searched.callback,this.searched.param,{ajax:this.searched_func})}}]),a}(),_createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),EmojidexUser=function(){function a(b){_classCallCheck(this,a),this.EC=b,this.auth_info=this.EC.Data._def_auth_info,this.History=new EmojidexUserHistory(this.EC),this.Favorites=new EmojidexUserFavorites(this.EC)}return _createClass(a,[{key:"_autoLogin",value:function(){if("verified"===__guard__(__guard__(__guard__(this.EC.Data.storage.hub_cache,function(a){return a.emojidex}),function(a){return a.auth_info}),function(a){return a.status}))return this.auth_info=this.EC.Data.storage.hub_cache.emojidex.auth_info,this.syncUserData()}},{key:"login",value:function(a){switch(a.authtype){case"plain":return this.plainAuth(a.username,a.password,a.callback);case"token":return this.tokenAuth(a.username,a.auth_token,a.callback);case"basic":return this.basicAuth(a.user,a.password,a.callback);case"session":if("verified"===__guard__(__guard__(__guard__(this.EC.Data.storage.hub_cache,function(a){return a.emojidex}),function(a){return a.auth_info}),function(a){return a.status}))return this.auth_info=this.EC.Data.storage.hub_cache.emojidex.auth_info;default:return this._autoLogin()}}},{key:"logout",value:function(){return this.EC.Data.auth_info(this.EC.Data._def_auth_info)}},{key:"_authenticateAPI",value:function(a,b){var c=this,d={url:this.EC.api_url+"users/authenticate",dataType:"json",success:function(a){return c._setAuthFromResponse(a).then(function(){return __guardFunc__(b,function(a){return a(c.auth_info)})})},error:function(a){var d=JSON.parse(a.responseText);return c.auth_info={status:d.auth_status,token:null,user:""},c.EC.Data.auth_info(c.EC.Data.auth_info).then(function(){return __guardFunc__(b,function(b){return b({auth_info:c.auth_info,error_info:a})})})}};return $.ajax($.extend(d,a))}},{key:"plainAuth",value:function(a,b,c){return this._authenticateAPI({data:{username:a,password:b}},c)}},{key:"tokenAuth",value:function(a,b,c){return this._authenticateAPI({data:{username:a,token:b}},c)}},{key:"basicAuth",value:function(a,b,c){return this._authenticateAPI({data:{user:a,password:b}},c)}},{key:"setAuth",value:function(a,b){var c=arguments.length>2&&void 0!==arguments[2]&&arguments[2],d=arguments.length>3&&void 0!==arguments[3]&&arguments[3],e=arguments.length>4&&void 0!==arguments[4]?arguments[4]:null,f=this,g=arguments.length>5&&void 0!==arguments[5]&&arguments[5],h=arguments.length>6&&void 0!==arguments[6]?arguments[6]:null;return this.EC.Data.auth_info({status:"verified",user:a,token:b,r18:c,premium:d,premium_exp:e,pro:g,pro_exp:h}).then(function(a){return f.auth_info=f.EC.Data.storage.get("emojidex.auth_info"),f.syncUserData(),a})}},{key:"_setAuthFromResponse",value:function(a){var b=this;return this.EC.Data.auth_info({status:a.auth_status,token:a.auth_token,user:a.auth_user,r18:a.r18,premium:a.premium,premium_exp:a.premium_exp,pro:a.pro,pro_exp:a.pro_exp}).then(function(a){return b.auth_info=b.EC.Data.storage.get("emojidex.auth_info"),b.syncUserData(),a})}},{key:"syncUserData",value:function(){this.History.token=this.Favorites.token=this.auth_info.token,this.Favorites.sync(),this.History.sync()}}]),a}(),_createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),EmojidexUserFavorites=function(){function a(b,c){_classCallCheck(this,a),this.EC=b,this.token=c,this._favorites=this.EC.Data.favorites()}return _createClass(a,[{key:"_favoritesAPI",value:function(a){if(null!=this.token){var b={url:this.EC.api_url+"users/favorites",dataType:"json"};return $.ajax($.extend(b,a))}}},{key:"get",value:function(a){var b=this,c={data:{auth_token:this.token},success:function(c){return b._favorites=c,b.EC.Data.favorites(c),__guardFunc__(a,function(a){return a(b._favorites)})}};return this._favoritesAPI(c)}},{key:"set",value:function(a){var b=this,c={type:"POST",data:{auth_token:this.token,emoji_code:a},success:function(a){return b._favorites.push(a),b.EC.Data.favorites(b._favorites)}};return this._favoritesAPI(c)}},{key:"unset",value:function(a){var b=this,c={type:"DELETE",data:{auth_token:this.token,emoji_code:a},success:function(a){return b.sync()}};return this._favoritesAPI(c)}},{key:"sync",value:function(){return this.get()}},{key:"all",value:function(a){var b=this;return null!=this._favorites?__guardFunc__(a,function(a){return a(b._favorites)}):setTimeout(function(){return b.all(a)},500),this._favorites}}]),a}(),_createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),EmojidexUserHistory=function(){function a(b,c){_classCallCheck(this,a),this.EC=b,this.token=c,this._history=this.EC.Data.history()}return _createClass(a,[{key:"_historyAPI",value:function(a){if(null!=this.token){var b={url:this.EC.api_url+"users/history",dataType:"json"};return $.ajax($.extend(b,a))}}},{key:"get",value:function(a){var b=this,c={data:{auth_token:this.token},success:function(c){return b._history=c,b.EC.Data.history(c),__guardFunc__(a,function(a){return a(b._history)})}};return this._historyAPI(c)}},{key:"set",value:function(a){var b=this,c={type:"POST",data:{auth_token:this.token,emoji_code:a},success:function(a){for(var c=0;c<b._history.length;c++){var d=b._history[c];if(d.emoji_code===a.emoji_code)return b._history[c]=a,b.EC.Data.history(b._history),a}}};return this._historyAPI(c)}},{key:"sync",value:function(){return this.get()}},{key:"all",value:function(a){var b=this;return null!=this._history?__guardFunc__(a,function(a){return a(b._history)}):setTimeout(function(){return b.all(a)},500),this._history}}]),a}(),_createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),EmojidexUtil=function(){function a(b){_classCallCheck(this,a),self=this,self.EC=b,self.a_pattern_base="<a href=[\"|'][^'|^\"]*['|\"] emoji-code=[\"|'][^'|^\"]*['|\"]><img class=[\"|']emojidex-emoji['|\"] src=[\"|'][^'|^\"]*['|\"] (emoji-code=[\"|'][^'|^\"]*['|\"] emoji-moji=[\"|'][^'|^\"]*['|\"]|emoji-code=[\"|'][^'|^\"]*['|\"]) alt=[\"|'][^'|^\"]*['|\"]( />|/>|>)</a>",self.img_pattern_base="<img class=[\"|']emojidex-emoji['|\"] src=[\"|'][^'|^\"]*['|\"] (emoji-code=[\"|'][^'|^\"]*['|\"] emoji-moji=[\"|'][^'|^\"]*['|\"]|emoji-code=[\"|'][^'|^\"]*['|\"]) alt=[\"|'][^'|^\"]*['|\"]( />|/>|>)",self.a_pattern=RegExp(self.a_pattern_base,"g"),self.img_pattern=RegExp(self.img_pattern_base,"g"),self.wrapped_a_pattern=RegExp("<span[^>]*>"+self.a_pattern_base+"</span>","g"),self.wrapped_img_pattern=RegExp("<span[^>]*>"+self.img_pattern_base+"</span>","g"),self.emoji_code_tag_attr_pattern=RegExp("emoji-code=[\"|']([^'|^\"]*)['|\"]",""),self.emoji_moji_tag_attr_pattern=RegExp("emoji-moji=[\"|']([^'|^\"]*)['|\"]",""),self.ignored_characters="'\":;@&#~{}<>\\r\\n\\[\\]\\!\\$\\+\\?\\%\\*\\/\\\\",self.short_code_pattern=RegExp(":([^\\s"+self.ignored_characters+"][^"+self.ignored_characters+"]*[^"+self.ignored_characters+"]):|:([^"+self.ignored_characters+"]):","g"),self.utf_pattern=RegExp(self.EC.Data.moji_codes.moji_array.join("|"),"g")}return _createClass(a,[{key:"escapeTerm",value:function(a){return a.replace(/\s/g,"_")}},{key:"deEscapeTerm",value:function(a){return a.replace(/_/g," ")}},{key:"makeURLSafe",value:function(a){return self.escapeTerm(a).replace(/\(/g,"%28").replace(/\)/g,"%29")}},{key:"encapsulateCode",value:function(a){return":"+self.unEncapsulateCode(a)+":"}},{key:"unEncapsulateCode",value:function(a){return a.replace(/\:/g,"")}},{key:"breakout",value:function(a){return null!=a?a instanceof Array?a:[a]:[]}},{key:"simplify",value:function(){var a=arguments.length>0&&void 0!==arguments[0]?arguments[0]:self.results,b=arguments.length>1&&void 0!==arguments[1]?arguments[1]:self.EC.size_code;for(i=0;i<a.length;i++)a[i].code=self.escapeTerm(a[i].code),a[i].img_url=self.EC.cdn_url+"/"+b+"/"+self.escapeTerm(a[i].code)+".png";return a}},{key:"emojify",value:function(a){var b=arguments.length>1&&void 0!==arguments[1]?arguments[1]:self.emojiToHTML;return self.emojifyMoji(a,b).then(function(a){return self.emojifyCodes(a,b)}).then(function(a){return a})}},{key:"emojifyMoji",value:function(a){var b=arguments.length>1&&void 0!==arguments[1]?arguments[1]:self.emojiToHTML;return new Promise(function(c,d){var e=a.match(self.utf_pattern);null!=e&&0!=e.length||c(a);var f=e.length,g=[],h=!0,i=!1,j=void 0;try{for(var k,l=e[Symbol.iterator]();!(h=(k=l.next()).done);h=!0){target=k.value;var m=""+target;self.EC.Search.find(self.EC.Data.moji_codes.moji_index[m]).then(function(c){return c.hasOwnProperty("code")&&g.push(b(c)),a}).then(function(a){f-=1})["catch"](function(a){f-=1}).then(function(){0==f&&(a=a.replace(self.utf_pattern,function(){return g[f++]}),c(a))})}}catch(n){i=!0,j=n}finally{try{!h&&l["return"]&&l["return"]()}finally{if(i)throw j}}})}},{key:"emojifyCodes",value:function(a){var b=arguments.length>1&&void 0!==arguments[1]?arguments[1]:self.emojiToHTML;return new Promise(function(c,d){var e=a.match(self.short_code_pattern);null!=e&&0!=e.length||c(a);var f=e.length,g=[],h=!0,i=!1,j=void 0;try{for(var k,l=function(){target=k.value;var d=""+target;self.EC.Search.find(self.EC.Util.unEncapsulateCode(d)).then(function(c){return c.hasOwnProperty("code")&&g.push({pre:d,post:b(c)}),a}).then(function(a){f-=1})["catch"](function(a){f-=1}).then(function(){if(0==f){var b=!0,d=!1,e=void 0;try{for(var h,i=g[Symbol.iterator]();!(b=(h=i.next()).done);b=!0)replacement=h.value,a=a.replace(replacement.pre,replacement.post)}catch(j){d=!0,e=j}finally{try{!b&&i["return"]&&i["return"]()}finally{if(d)throw e}}c(a)}})},m=e[Symbol.iterator]();!(h=(k=m.next()).done);h=!0)l()}catch(n){i=!0,j=n}finally{try{!h&&m["return"]&&m["return"]();
}finally{if(i)throw j}}})}},{key:"emojifyToHTML",value:function(a){return self.emojify(a,self.emojiToHTML)}},{key:"emojifyToMD",value:function(a){return self.emojify(a,self.emojiToMD)}},{key:"emojiToHTML",value:function(a){var b=arguments.length>1&&void 0!==arguments[1]?arguments[1]:self.EC.defaults.size_code,c='<img class="emojidex-emoji" src="https://'+self.EC.env.cdn_addr+"/emoji/"+b+"/"+self.escapeTerm(a.code)+'.png" emoji-code="'+self.escapeTerm(a.code)+'"'+(null==a.moji||""==a.moji?"":' emoji-moji="'+a.moji+'"')+' alt="'+self.deEscapeTerm(a.code)+'" />';return null!=a.link&&""!=a.link?'<a href="'+a.link+'" emoji-code="'+self.escapeTerm(a.code)+'">'+c+"</a>":c}},{key:"emojiToMD",value:function(a){var b=arguments.length>1&&void 0!==arguments[1]?arguments[1]:self.EC.defaults.size_code,c="!["+(null==a.moji||""==a.moji?a.code:a.moji)+"](https://"+self.EC.env.cdn_addr+"/emoji/"+b+"/"+self.escapeTerm(a.code)+'.png "'+self.deEscapeTerm(a.code)+'")';return null!=a.link&&""!=a.link?"["+c+" ]("+a.link+")":c}},{key:"deEmojifyHTML",value:function(a){var b=!(arguments.length>1&&void 0!==arguments[1])||arguments[1];a=self._deEmojifyWrappedHTML(""+a,b),a=self.deLinkHTML(a);var c=a.match(self.img_pattern);if(null==c)return a;var d=!0,e=!1,f=void 0;try{for(var g,h=c[Symbol.iterator]();!(d=(g=h.next()).done);d=!0){if(target=g.value,b){var i=target.match(self.emoji_moji_tag_attr_pattern);if(null!=i&&1!=i.length){a=a.replace(target,i[1]);continue}}var j=target.match(self.emoji_code_tag_attr_pattern);a=a.replace(target,self.encapsulateCode(j[1]))}}catch(k){e=!0,f=k}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return a}},{key:"_deEmojifyWrappedHTML",value:function(a){var b=!(arguments.length>1&&void 0!==arguments[1])||arguments[1];a=self.deLinkHTML(a);var c=a.match(self.wrapped_img_pattern);if(null==c)return a;var d=!0,e=!1,f=void 0;try{for(var g,h=c[Symbol.iterator]();!(d=(g=h.next()).done);d=!0){if(target=g.value,b){var i=target.match(self.emoji_moji_tag_attr_pattern);if(null!=i&&1!=i.length){a=a.replace(target,i[1]);continue}}var j=target.match(self.emoji_code_tag_attr_pattern);a=a.replace(target,self.encapsulateCode(j[1]))}}catch(k){e=!0,f=k}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return a}},{key:"deLinkHTML",value:function(a){a=self._deLinkWrappedHTML(""+a);var b=a.match(self.a_pattern);if(null==b)return a;for(var c=0;c<b.length;c++)a=a.replace(b[c],b[c].match(self.img_pattern)[0]);return a}},{key:"_deLinkWrappedHTML",value:function(a){var b=a.match(self.wrapped_a_pattern);if(null==b)return a;for(var c=0;c<b.length;c++)a=a.replace(b[c],b[c].match(self.img_pattern)[0]);return a}},{key:"getContext",value:function(){return self}}]),a}();